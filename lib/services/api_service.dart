...
import 'dart:convert';
import 'package:http/http.dart' as http;
import 'package:first_mobile_app_afg_network/config/app_config.dart'; // ✅ Added for base URL config
...
class ApiService {
  final String baseUrl = AppConfig.baseUrl; // ✅ Use dynamic base URL from config
